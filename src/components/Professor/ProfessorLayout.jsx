          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-lg font-bold text-gray-900">Valle Grande</h1>
                  <p className="text-xs text-gray-500">Portal Docente</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-medium text-gray-900">Prof. {user.first_name} {user.last_name}</p>
                <p className="text-xs text-gray-500">{user.department || 'Docente'}</p>
              </div>
              <button
